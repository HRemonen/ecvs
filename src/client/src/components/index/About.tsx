...
const About = () => (
  <div id="about" className="snap-center bg-gray-300 w-full h-screen flex items-center justify-center">
    <div className='mx-8'>
    ...
    <img 
      className="hidden lg:block object-cover h-[480px] w-[480px] rounded-3xl mt-[-200px] lg:ml-[200px] shadow-xl border-2 border-gray-800 hover:shadow-2xl hover:blur-sm" 
